...
const CharacterDetail = ({ route }) => {
  ...
  function getData() {
    fetch(
      "https://api.npoint.io/fbca41d3404d48034f9e/characters/" +
        route.params.msg
    )
  ...
  return (
    <View style ={styles.container}>
        <View style={styles.card}>
          <Text style={styles.textJudul}>{data.name}</Text>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.circle}>
              <Text style={styles.text2}>{data.school}</Text>
            </View>
          </View>
          <View style={styles.container}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.circle}>
              <Text style={styles.text2}>{data.damageType}</Text>
            </View>
          </View>
      </View>
    </View>
